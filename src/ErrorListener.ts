...
export interface ITurtleLangError {
...
export default class TurtleLangErrorListener implements ANTLRErrorListener<any>{
  private errors: ITurtleLangError[] = []
